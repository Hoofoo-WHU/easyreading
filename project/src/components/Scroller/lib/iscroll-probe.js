...
// INSERT POINT: _end
	...
	refresh: function (fix) {
		...
		var _fix = {top:0,right:0,bottom:0,left:0};
		if (fix) {
			_fix.top = fix.top || 0;
			_fix.right = fix.right || 0;
			_fix.bottom = fix.bottom || 0;
			_fix.left = fix.left || 0;
		}
...
/* REPLACE START: refresh */
		...
		this.maxScrollX		= this.wrapperWidth - this.scrollerWidth + _fix.right;
		this.maxScrollY		= this.wrapperHeight - this.scrollerHeight + _fix.bottom;
		this.minScrollX     = _fix.left;
		this.minScrollY     = _fix.top;
